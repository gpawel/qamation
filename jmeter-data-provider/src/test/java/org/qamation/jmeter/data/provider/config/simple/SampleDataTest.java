package org.qamation.jmeter.data.provider.config.simple;
...
public class SampleDataTest extends JMeterTestCase {
    ...
    private String dataProviderImplClassName = "org.qamation.data.excelReader.DataProviderExcelAdapter";
    ...
    public void createSimpleDataTest() {
        ...
        Assert.assertEquals(SimpleDataConfig.SHARE_MODE_ALL,data.getShareMode());
    }

    // @Test will not work without starting up gui less Jmeter. need to learn how.
    public void setDifferentShareMode() {
        SimpleDataConfig forAll = createSimpleData(dataProviderImplClassName,fileName, "forAll",true, SimpleDataConfig.SHARE_MODE_ALL);
        SimpleDataConfig forThread = createSimpleData(dataProviderImplClassName,fileName, "forThread",true, SimpleDataConfig.SHARE_MODE_THREAD);
    ...
    private SimpleDataConfig createSimpleData(String dataProviderImplClassName, String fileName, String label, boolean resetAtEOF, String shareMode) {
        SimpleDataConfig data = new SimpleDataConfig();
